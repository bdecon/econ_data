...
CodebookNotes = {'MONTH': {'Notes': 'Survey reference month. Original CPS variable: HRMONTH', 
                  ...
                  'RWKEARN': {'Notes': 'Real weekly earnings, in USD, adjusted for inflation by regional CPI-U. The base period is always the latest month of available CPI data. Based on WKEARN.', 'Name': 'Real usual weekly earnings'},
                  'RWKEARNADJ': {'Notes': 'Real weekly earnings, in USD, adjusted for inflation by regional CPI-U. The base period is always the latest month of available CPI data. Based on WKEARNADJ, which includes imputation for topcoded observations.', 'Name': 'Real usual weekly earnings, topcode adjusted'},
