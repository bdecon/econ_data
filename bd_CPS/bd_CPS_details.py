...
CodebookNotes = {'MONTH': {'Notes': 'Survey reference month. Original CPS variable: HRMONTH', 
                  ...
                  'HGCI': {'Name': 'Imputed highest grade completed', 'Notes': 'Imputed years of schooling (0-18 scale) following Jaeger (2002). For 1989-1991, uses actual CPS highest grade completed/attended variables. For 1992-1997, uses simple linearization from degree codes. For 1998-2014, uses supplemental CPS questions on GED grade, college credits, and graduate courses. Post-2014 uses simplified imputation for BA/MA holders due to dropped graduate course questions.'},
                  ...
                  'NILFREASON': {'Notes': 'Primary reason person is not in the labor force. Derived from PEMLR, PRWNTJOB, PEDWWNTO, and PENLFACT.',
                              'Name': 'NILF reason'},
                  'NLFFAM': {'Notes': 'Primary reason person not in the labor force is family or home responsibilities, regardless of whether the person wants a job. Derived from PENLFACT.',
                              'Name': 'NILF for family or home responsibilities'},
                  ...
                  'INDM': {'Notes': 'Major Industry code for main job, consistent across years.', 
                           'Name': 'Major industry recode, main job (consistent)'},
                  'MANAGER': {'Notes': 'Detailed occupation recode == 1, Managerial occupations', 'Name': 'Manager, main job'},
                  'IND80': {'Notes': 'Industry code for main job. Available 1989 to 1991.', 'Name': 'Industry, main job'},
                  'OCC80': {'Notes': 'Occupation code for main job. Available 1989 to 1991.', 'Name': 'Occupation, main job'},
                  'IND280': {'Notes': 'Industry code for second job. Available 1989 to 1991.', 'Name': 'Industry, second job'},
                  'OCC280': {'Notes': 'Occupation code for second job. Available 1989 to 1991.', 
                             'Name': 'Occupation, second job'},
                  'IND90': {'Notes': 'Industry code for main job. Available 1992 to 2002.', 'Name': 'Industry, main job'},
                  'OCC90': {'Notes': 'Occupation code for main job. Available 1992 to 2002.', 'Name': 'Occupation, main job'},
                  'IND290': {'Notes': 'Industry code for second job. Available 1992 to 2002.', 'Name': 'Industry, second job'},
                  'OCC290': {'Notes': 'Occupation code for second job. Available 1992 to 2002.', 
                             'Name': 'Occupation, second job'},
                  'IND02': {'Notes': 'Industry code for main job. Available 2003 to 2008.', 'Name': 'Industry, main job'},
                  'OCC00': {'Notes': 'Occupation code for main job. Available 2003 to 2010.', 'Name': 'Occupation, main job'},
                  'IND202': {'Notes': 'Industry code for second job. Available 2003 to 2008.', 'Name': 'Industry, second job'},
                  'OCC200': {'Notes': 'Occupation code for second job. Available 2003 to 2010.', 
                             'Name': 'Occupation, second job'},
                  'IND07': {'Notes': 'Industry code for main job. Available 2009 to 2013.', 'Name': 'Industry, main job'},
                  'OCC10': {'Notes': 'Occupation code for main job. Available 2011 to 2019.', 'Name': 'Occupation, main job'},
                  'IND207': {'Notes': 'Industry code for second job. Available 2009 to 2013.', 'Name': 'Industry, second job'},
                  'OCC210': {'Notes': 'Occupation code for second job. Available 2011 to 2019.', 
                             'Name': 'Occupation, second job'},
                  'IND12': {'Notes': 'Industry code for main job. Available 2014 to 2019.', 'Name': 'Industry, main job'},
                  'IND212': {'Notes': 'Industry code for second job. Available 2014 to 2019.', 'Name': 'Industry, second job'},
                  'IND17': {'Notes': 'Industry code for main job. Available 2020 to 2024.', 'Name': 'Industry, main job'},
                  'IND25': {'Notes': 'Industry code for main job. Available 2025 onward.', 'Name': 'Industry, main job'},
                  'OCC18': {'Notes': 'Occupation code for main job. Available 2020 onward.', 'Name': 'Occupation, main job'},
                  'IND217': {'Notes': 'Industry code for second job. Available 2020 to 2024.', 'Name': 'Industry, second job'},
                  'IND225': {'Notes': 'Industry code for second job. Available 2025 onward.', 'Name': 'Industry, second job'},
                  'OCC218': {'Notes': 'Occupation code for second job. Available 2020 onward.', 
                             'Name': 'Occupation, second job'},
                  'IND80M': {'Notes': 'Major industry recode for main job. Available 1989 to 2002.', 
                             'Name': 'Major industry recode, main job'},
                  'OCC80M': {'Notes': 'Major occupation code for main job. Available 1989 to 2002.', 
                             'Name': 'Occupation, main job'},
                  'IND280M': {'Notes': 'Major industry recode for second job. Available 1989 to 2002.', 
                              'Name': 'Major industry recode, second job'},
                  'OCC280M': {'Notes': 'Major occupation recode for second job. Available 1989 to 2002.', 
                             'Name': 'Major occupation recode, second job'},
                  'IND03M': {'Notes': 'Major industry recode for main job. Available 2000 onward.', 
                             'Name': 'Major industry recode, main job'},
                  'OCC03M': {'Notes': 'Major occupation code for main job. Available 2000 onward.', 
                             'Name': 'Major occupation recode, main job'},
                  'IND203M': {'Notes': 'Major industry recode for second job. Available 2000 onward.', 
                              'Name': 'Major industry recode, second job'},
                  'OCC203M': {'Notes': 'Major occupation recode for second job. Available 2000 onward.', 
                             'Name': 'Major occupation recode, second job'},
                  'IND80D': {'Notes': 'Detailed industry recode for main job. Available 1989 to 2002.', 
                             'Name': 'Detailed industry recode, main job'},
                  'OCC80D': {'Notes': 'Detailed occupation code for main job. Available 1989 to 2002.', 
                             'Name': 'Detailed occupation recode, main job'},
                  'IND280D': {'Notes': 'Detailed industry recode for second job. Available 1989 to 2002.', 
                              'Name': 'Detailed industry recode, second job'},
                  'OCC280D': {'Notes': 'Detailed occupation recode for second job. Available 1989 to 2002.', 
                             'Name': 'Detailed occupation recode, second job'},
                  'IND03D': {'Notes': 'Detailed industry recode for main job. Available 2000 onward.', 
                             'Name': 'Detailed industry recode, main job'},
                  'OCC03D': {'Notes': 'Detailed occupation code for main job. Available 2000 onward.', 
                             'Name': 'Detailed occupation recode, main job'},
                  'IND203D': {'Notes': 'Detailed industry recode for second job. Available 2000 onward.', 
                              'Name': 'Detailed industry recode, second job'},
                  'OCC203D': {'Notes': 'Detailed occupation recode for second job. Available 2000 onward.', 
                             'Name': 'Detailed occupation recode, second job'},
                  ...
                  'USLFT': {'Notes': 'Indicates if someone is usually employed full-time or usually works 35 or more hours per week at their main job. Derived from PEHRFTPT and PEHRUSL1 from 1994 onward and from A-USLFT and A-USLHRS from 1989 to 1993.', 'Name': 'Usually work full-time'},
                  ...
                  'PAIDHRLY': {'Notes': 'Indicates whether person is usually paid on a per-hour basis. Derived from PEERNHRY.',
                          'Name': 'Paid hourly'},
                  'WKEARN': {'Notes': 'Nominal weekly earnings, in USD. Includes reported overtime, tips, and commissions. Derived from PRERNWA (1994-onward) and A-WERNTP (1989-93).', 'Name': 'Usual weekly earnings'},
                  'WKEARNADJ': {'Notes': 'Nominal usual weekly earnings, before deductions, including overtime, tips, and commissions. This version also has the topcoded wages replaced with values imputed based on the assumption that earnings are log-normally distributed. The process replicates the method used in CEPRdata, from John Schmitt, with some minor differences. Topcodes are replaces for eight groups by sex and Census region.', 'Name': 'Usual weekly earnings, topcode adjusted'},
                  'PTWK':{'Notes': 'Equal to 1 if observation is topcoded', 'Name': 'Weekly earnings topcode flag'},
                  ...
                  'PRICEADJ': {'Name': 'Regional CPI Deflator', 'Notes': 'Price deflator for individual for each region and month. Multiplying a wage variable by this will convert the wage variable into the price adjusted version. The base period is the latest month of available CPI data.'},
                  ...
                  'DWTYPE': {'Name': 'Discouraged Worker Type', 'Notes': 'The BLS definition of discouraged worker is narrow. In NILFREASON, anyone who wants a job is considered "Discouraged". This variable allows identifying which people from the NILFREASON category are also in the BLS category. Derived from PRDISC and PRJOBSEA.'},
                  'NUMJOBS': {'Name': 'Number of Jobs', 'Notes': 'Number of jobs, 0-4, topcoded at 4. Derived from PEMJNUM.'},
                  'RETIRED': {'Name': 'Retired', 'Notes': 'Notes if someone who is not in the labor force is retired. Some are marked Discouraged in NILFREASON because they want a job.'},
                  'ATLFLG': {'Name': 'Atlanta Fed Wage Growth Tracker Eligibility Flag',
                  ...
                  'PRAGNA': {'Name': 'Agricultural worker', 'Notes': 'Agricultural industry recode. 1=Agricultural, 2=Non-agricultural, -1=NIU'},
                  'PRFAMREL': {'Name': 'Family relationship', 'Notes': 'Detailed family relationship recode. 0=Not a family member, 1=Reference person, 2=Spouse, 3=Child, 4=Other relative'},
                  'PRHERNAL': {'Name': 'Hourly earnings allocation flag', 'Notes': 'Flag indicating hourly earnings were allocated by BLS. 0=Not allocated, 1=Allocated, -1=NIU'},
                  'PRNAGWS': {'Name': 'Non-agricultural wage/salary', 'Notes': 'Non-agricultural wage and salary worker. 1=Yes, -1=NIU'},
                  'PRWKSTAT': {'Name': 'Work status recode', 'Notes': 'Detailed labor force and work status recode. Combines employment status, hours, and reasons for part-time work.'},
                  'PRWNTJOB': {'Name': 'Want a job', 'Notes': 'Does person not in labor force want a job now. 1=Yes, 2=No/maybe, -1=NIU'}}


ValueLabels = {'IND80': {10: 'Agricultural production, crops',
 ...
 'IND90': {10: 'Agricultural production, crops',
  11: 'Agricultural production, livestock',
  ...
  991: 'Unemployed, last job armed forces',
  992: 'Unemployed, not worked last 5 years'}, 
 'IND02': {170: 'Crop production',
 ...
 'IND07': {170: 'Crop production',
  ...
  380: 'Coal mining',
  390: 'Metal ore mining',
  470: 'Nonmetallic mineral mining and quarrying (Starting May 2012 includes 0480)',
  480: 'Not specified type of mining (Ends April 2012)',
  490: 'Support activities for mining',
  570: 'Electric power generation, transmission and distribution',
  580: 'Natural gas distribution',
  590: 'Electric and gas, and other combinations',
  ...
  8790: 'Electronic and precision equipment repair and maintenance',
  8870: 'Commercial and industrial machinery and equipment repair and maintenance',
  8880: 'Personal and household goods repair and maintenance (Starting May 2012 includes 8890)',
  8890: 'Footwear and leather goods repair (Ends April 2012)',
  8970: 'Barber shops',
  8980: 'Beauty salons',
  8990: 'Nail salons and other personal care services',
  9070: 'Dry cleaning and laundry services',
...
'IND12': {170: 'Crop production',
 ...
 1990: 'Printing and related support activities',
 2070: 'Petroleum refining',
 2090: 'Petroleum and coal products manufacturing, exc. refineries',
 2170: 'Resin, synthetic rubber, and fibers and filaments manufacturing',
 2180: 'Pesticide, Fertilizer, and other agricultural chemical manufacturing',
 2190: 'Pharmaceutical and medicine manufacturing',
 2270: 'Paint, coating, and adhesive manufacturing',
 2280: 'Soap, cleaning compound, and toilet preparation manufacturing',
 2290: 'Basic chemical manufacturing, and other chemical product and preparation manufacturing',
 2370: 'Plastics product manufacturing',
 2380: 'Tire manufacturing',
 2390: 'Rubber products, except tires, manufacturing',
 2470: 'Pottery, ceramics, and plumbing fixture manufacturing',
 ...
 4691: 'Automotive parts, accessories, and tire stores',
 4771: 'Furniture and home furnishings stores',
 4780: 'Household appliance stores',
 4796: 'Electronics stores',
 ...
 5276: 'Sporting goods, and hobby and toy stores',
 5281: 'Sewing, needlework, and piece goods stores',
 5296: 'Musical instrument and supplies stores',
 ...
 7190: 'Commercial and industrial machinery and equipment, and nonfinancial intangible assets rental and leasing',
 7270: 'Legal services',
 7280: 'Accounting, tax preparation, bookkeeping, and payroll services',
 7290: 'Architectural, engineering, and related services',
 7370: 'Specialized design services',
...
'OCC90': {0: 'No occupation',
  ...
  14: 'Chief executive, general administration, public administration',
  15: 'Managers, medicine and health',
  16: 'Postmasters and superintendents',
  17: 'Managers--food service and lodging establishments',
  18: 'Managers, properties and real estate',
  19: 'Funeral directors',
  21: 'Business and promotion managers',
  22: 'Managers and administrators n.e.c.',
  23: 'Accountants and auditors',
  24: 'Underwriters',
  25: 'Other financial officers',
  26: 'Management analysts',
  27: 'Personal, training and labor relation specialists',
  28: 'Purchasing agents',
  29: 'Buyers, wholesale and retail trade',
  33: 'Purchasing agents, n.e.c.',
  34: 'Supervisors and proprietors, sales occupation.',
  35: 'Construction inspectors',
  36: 'Inspectors compliance officers',
  37: 'Management occupations, n.e.c.',
  43: 'Architects',
  44: 'Engineers, aeronautical',
  45: 'Engineers, metallurgical, metallurgists',
  46: 'Engineers, mining',
  47: 'Engineers, petroleum',
  48: 'Engineers, chemical',
  49: 'Nuclear scientists',
  53: 'Engineers, civil',
  54: 'Agricultural',
  55: 'Engineers, electrical',
  56: 'Industrial',
  57: 'Mechanical',
  ...
  65: 'Operations and system analysts',
  66: 'Actuaries',
  67: 'Statisticians',
  68: 'Mathematical scientists',
  69: 'Physicians and astronomers',
  73: 'Chemists',
  74: 'Atomic and space scientists',
  75: 'Geologists',
  76: 'Physical scientists, n.e.c.',
  77: 'Agricultural scientists',
  78: 'Biological scientists',
  79: 'Foresters and conservationists',
  ...
  147: 'Trade and industrial teachers',
  148: 'Theology teachers',
  ...
  217: 'Draftsmen',
  218: 'Surveyors and mapping technicians',
  ...
  416: 'Service occupations',
  417: 'Firefighting occupations',
  418: 'Police, detective public services',
  423: 'Sheriffs, bailiffs and other law enforcement',
  424: 'Correctional institution officers',
  425: 'Crossing guards',
  426: 'Guards and police except public services',
  427: 'Service occupations, except protective and household',
  ...
  459: 'Attendants, amusements and recreational facilities',
  461: 'Guides',
  462: 'Ushers',
  ...
  563: 'Brick masons and stonemasons',
  564: 'Brick mason',
  565: 'Tile setters',
  ...
  583: 'Paperhangers',
  584: 'Plasterers',
  585: 'Plumbers, pipe fitters',
  587: 'Plumber, pipe fitters',
  588: 'Concrete finishers',
  589: 'Glaziers',
  593: 'Insulation workers',
  594: 'Paving, surfacing equipment operators',
  595: 'Roofers',
  ...
  628: 'Supervisor, production occupations',
  ...
  703: 'Lathe and turning machine operators',
  ...
  864: 'Supervisors, laborers, n.e.c.',
  865: 'Helpers, machiners, repairers',
  866: 'Helpers, construction trade',
  867: 'Helpers, surveyors',
  868: 'Helpers, extractive operations',
  869: 'Construction laborers',
  874: 'Production helpers',
  875: 'Garbage collectors',
  876: 'Stevedores',
  877: 'Stock handlers and baggers',
  878: 'Machine feeders and off beaters',
  883: 'Freight, stock material handlers, n.e.c.',
  885: 'Garage and service station occupations.',
...
'OCC80': {0: 'No occupation',
  ...
  15: 'Managers, medicine and health',
  16: 'Managers, properties and retail',
  17: 'Postmasters and superintendents',
  18: 'Funeral directors',
  19: 'Managers and adminstrators. n.e.c.',
  23: 'Accountants and auditors',
  24: 'Underwriters',
  25: 'Other financial officers',
  26: 'Management analysts',
  ...
  29: 'Buyers, wholesale and retail trade',
  33: 'Purchasing agents, n.e.c.',
  34: 'Business and promotion managers',
  35: 'Construction inspectors',
  36: 'Inspectors compliance officers',
  37: 'Management occupations, n.e.c.',
  43: 'Architects',
  ...
  58: 'Marine and naval architects',
  59: 'Engineers n.e.c.',
  63: 'Surveyers and mapping scientists',
  64: 'Computer system analysts',
  65: 'Operations and system analysts',
  66: 'Actuaries',
  67: 'Statisticians',
...
'IND03D':{1: 'Agriculture',
 ...
 52: 'Armed forces'},
'OCC03D': {1: 'Management occupations',
 ...
 23: 'Armed Forces'},
'IND03M': {1: 'Agriculture, forestry, fishing, and hunting',
 2: 'Mining',
 3: 'Construction',
 4: 'Manufacturing',
...
'OCC03M': {1: 'Management, business, and financial occupations',
