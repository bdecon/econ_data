...
INDMMap = {
    ...
    {'IND80': [230, 231, 232, 241, 242, 250, 251, 252, 261,
     ...
     'IND17': [2470, 2480, 2490, 2570, 2590, 2670, 2680, 2690, 
               2770, 2780, 2790, 2870, 2880, 2890, 2970, 2980, 
               2990, 3070, 3080, 3095, 3170, 3180, 3191, 3365, 
               3370, 3380, 3390, 3470, 3490, 3570, 3580, 3590, 
               3670, 3680, 3690, 3770, 3780, 3790, 3875, 3895, 
               3960, 3970, 3980, 3990]},
...
CodebookNotes = {'MONTH': {'Notes': 'Survey reference month. Original CPS variable: HRMONTH', 
                  ...
                  'IND17': {'Notes': 'Industry code for main job. Available 2020 onward.', 'Name': 'Industry, main job'},
                  'OCC18': {'Notes': 'Occupation code for main job. Available 2020 onward.', 'Name': 'Occupation, main job'},
                  'IND217': {'Notes': 'Industry code for second job. Available 2020 onward.', 'Name': 'Industry, second job'},
