...
VarList = ['PWORWGT', 'PWCMPWGT', 'PRERNWA', 'PEPARENT', 'PESPOUSE',
           ...
           'PENLFRET', 'PENLFACT', 'GESTFIPS', #'PRFAMREL', 'PRFAMNUM',
...
CodebookNotes = {'MONTH': {'Notes': 'Survey reference month. Original CPS variable: HRMONTH', 
                  ...
                  'NCHILDU5':{'Notes': 'Number of own children under age 5 (age 0-4).',
                              'Name': 'Number of own children under 5'},
                  'NCHILDU18':{'Notes': 'Number of own children under age 18 (age 0-17).',
