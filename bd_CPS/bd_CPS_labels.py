"""
Value labels and codebook notes for bd CPS variables.

This module contains:
- CodebookNotes: Variable documentation for codebook generation
- ValueLabels: Value labels for coded variables (IND80, IND90, OCC*, CBSA, CSA, COUNTY, etc.)

This file was split from bd_CPS_details.py for better organization.
"""
...
CodebookNotes = {'MONTH': {'Notes': 'Survey reference month. Original CPS variable: HRMONTH', 
                  ...
                  'COW1DT': {'Notes': "Detailed class of worker on main job (10 categories). Derived from PEIO1COW and PRDTCOW1. Categories: Agricultural (any), Federal Government, State Government, Local Government, Private Household, Private For Profit, Private Nonprofit, Self-employed Incorporated, Self-employed Unincorporated, Without Pay. Available 1994+.",
                             'Name': 'Detailed class of worker 1'},
                  ...
                  'OCCPD': {'Name': 'Any physical demands', 'Notes': 'Employment-weighted proportion of occupation requiring any physical demands, based on O*NET work activities and context. Physical demands include general physical activities, handling objects, standing, walking, and repetitive motions. Range 0-1, where 1 means all SOC codes in the occupation meet criteria. Available 2003+. Derived from O*NET data.'},
                  'OCCHPD': {'Name': 'High physical demands', 'Notes': 'Employment-weighted proportion of occupation requiring high/strenuous physical demands, based on O*NET abilities (strength, stamina) and work context (bending, kneeling). Range 0-1. Available 2003+. Derived from O*NET data.'},
                  'OCCDWC': {'Name': 'Difficult working conditions', 'Notes': 'Employment-weighted proportion of occupation with difficult working conditions: outdoor work, non-climate-controlled environments, exposure to hazards, contaminants, or noise. Range 0-1. Available 2003+. Derived from O*NET data.'},
                  'OCCTLWK': {'Name': 'Telework feasibility', 'Notes': 'Employment-weighted proportion of occupation suitable for telework, using DFLP methodology (Dey et al. 2021). Based on O*NET work activities and context. Range 0-1, where 1 means fully telework-feasible. Available 2003+. Derived from O*NET data.'},
                  'OCCAI': {'Name': 'AI exposure', 'Notes': 'AI exposure score based on Pew Research methodology (2023). Measures relative importance of high-AI-exposure work activities (information processing, computer work, data analysis) vs medium/low exposure activities. Range ~0.30-0.40, higher = more exposed. Available 2003+. Derived from O*NET data.'},
                  'OCCJZ': {'Name': 'Job Zone', 'Notes': 'O*NET Job Zone (1-5 scale) indicating preparation level typically needed for the occupation. Zone 1=Little/none, 2=HS diploma, 3=Vocational/associates, 4=Bachelors, 5=Graduate degree. Use for education mismatch: EDUMISMATCH = WORKER_JZ - OCCJZ (positive=overqualified). Fractional values occur when Census occupation maps to multiple SOC codes. Available 2003+. Derived from O*NET data.'}}
